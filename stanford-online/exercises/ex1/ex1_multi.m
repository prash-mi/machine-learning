...
% now X is the normalized features, mu is the mean and sigma is the standard deviation 
...
fprintf('Theta: ');
theta
plot(1:num_iters, J_history(1:num_iters), 'k');

xlabel('Number of iterations');
ylabel('Cost J');
title('Comparision of learning rates');
